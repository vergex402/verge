...
export default function WalletDashboard() {
  ...
  const mainContent = () => {
    ...
    if (!isConnected) return <>
      ...
      <div className="mb-5 grid gap-3 sm:grid-cols-3"><button onClick={() => setActive("Marketplace")} className="rounded-2xl border border-white/[0.07] bg-[#141616] p-4 text-left transition hover:border-white/15"><div className="flex size-9 items-center justify-center rounded-xl bg-emerald-300/[0.08] text-emerald-200"><AppIcon name="marketplace" size={17}/></div><div className="mt-4 text-sm font-medium text-white/85">Discover endpoints</div><div className="mt-1 text-[11px] text-white/40">Browse public x402 listings.</div></button><a href="/docs#express" className="rounded-2xl border border-white/[0.07] bg-[#141616] p-4 transition hover:border-white/15"><div className="flex size-9 items-center justify-center rounded-xl bg-white/[0.04] text-white/55"><AppIcon name="docs" size={17}/></div><div className="mt-4 text-sm font-medium text-white/85">Integrate the SDK</div><div className="mt-1 text-[11px] text-white/40">Express, Hono, and x402 flow.</div></a><button onClick={authorize} disabled={!onRobinhood || authBusy} className="rounded-2xl border border-white/[0.07] bg-[#141616] p-4 text-left transition hover:border-emerald-200/20 disabled:cursor-not-allowed disabled:opacity-50"><div className="flex size-9 items-center justify-center rounded-xl bg-white/[0.04] text-white/55"><AppIcon name="key" size={17}/></div><div className="mt-4 text-sm font-medium text-white/85">Open private workspace</div><div className="mt-1 text-[11px] text-white/40">Sign once to publish and manage keys.</div></button></div>
