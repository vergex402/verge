...
Hono middleware for **x402 v2-compatible** HTTP 402 stablecoin micropayments. Defaults to **USDG on Robinhood Chain** (ID `4663`), with explicit Base/Arbitrum/Polygon USDC support through the shared core.
